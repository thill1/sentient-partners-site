...
export const SCENARIOS: Scenario[] = [
  {
    ...
    beats: [
      ...
      { speaker: 'agent', text: "For a new patient it's typically one hundred eighty to two hundred sixty dollars depending on the exam. Dr. Patel has an emergency opening tomorrow at eight thirty AM. Would you like me to hold it for you?", ledger: 'pricing' },
      { speaker: 'caller', text: 'Yes please, that would be great.' },
      { speaker: 'agent', text: "Done. You're booked for tomorrow at eight thirty AM with Dr. Patel. I'm texting you a confirmation with our address and what to expect. Try to keep the crown safe tonight, and we'll see you in the morning.", ledger: 'booked' },
    ],
    ledger: [
  ...
  },
  {
    ...
    beats: [
      ...
      { speaker: 'agent', text: "That sounds like it could be a capacitor, which is a common fix. The weekend diagnostic is ninety nine dollars and gets applied to the repair. I have a technician window tomorrow between nine and eleven AM. Shall I lock that in?", ledger: 'pricing' },
      { speaker: 'caller', text: "Yes, book it. It's miserable in here." },
      { speaker: 'agent', text: "You're confirmed for tomorrow morning, nine to eleven AM. I've texted you the confirmation and a photo of your technician, Marcus. One more thing — I can add you to our priority membership so emergencies like this jump the line. I'll include the details in the text.", ledger: 'booked' },
    ],
    ledger: [
  ...
  },
  {
    ...
    beats: [
      ...
      { speaker: 'agent', text: "I'm sorry to hear that, and it's good you have that visit documented. Please don't give the insurer a recorded statement before your consultation. Attorney Hartwell has an opening Monday at ten AM for a free case review. May I reserve it for you?", ledger: 'advised' },
      { speaker: 'caller', text: 'Yes, Monday at ten works.' },
      { speaker: 'agent', text: "You're scheduled for Monday at ten AM. I'm sending a confirmation with a short checklist — photos, the police report number, and your urgent care paperwork. Until then, let all insurance calls go to voicemail. We'll take it from here.", ledger: 'booked' },
    ],
    ledger: [
  ...
  },
  {
    ...
    beats: [
      ...
      { speaker: 'agent', text: "Then you'll love our coached small-group strength sessions — built-in accountability. There's a six AM class Thursday, which seems like your hour. Want me to reserve your trial spot?", ledger: 'matched' },
      { speaker: 'caller', text: "Ha, it is my hour. Yes, book me in." },
      { speaker: 'agent', text: "Locked in — Thursday six AM with Coach Rivera. I've texted your trial pass and what to bring. If you crush it, your first week is free and there's a founding-member rate waiting. See you Thursday.", ledger: 'booked' },
    ],
    ledger: [
