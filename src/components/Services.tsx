    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="relative">
          {/* Local glow behind the services card */}
          <div
            aria-hidden="true"
          ...
          {/* Floating glass card containing header + grid */}
          <div className="rounded-3xl bg-white/6 dark:bg-slate-950/75 border border-white/10 backdrop-blur-xl shadow-[0_24px_70px_rgba(15,23,42,0.85)] p-8 sm:p-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed">
                We integrate cutting-edge AI directly into your existing
                workflow, replacing manual grunt work with instant, 24/7 performance.
              </p>
            </div>
                      ...
                      className={`
                        ...
                        ${
                          isDarkCard
                            ...
                            : 'bg-white/80 dark:bg-dark-card text-slate-900 dark:text-white shadow-sm border border-slate-100/70 dark:border-dark-border'
                        }
                      `}
                    >
                      {isDarkCard && (
